...
CATEGORIES = {
    ...
    "🏘️ Communes Agglo": [
        ...
        "les grandes-loges", "haussimont", "isse", "jâlons", "jalons",
        "juvigny", "lenharrée", "livry-louvercy", "matougues",
        "moncetz-longevas", "montépreux", "montepreux",
        "mourmelon-le-grand", "mourmelon-le-petit",
        "recy", "saint-étienne-au-temple", "saint etienne au temple",
        "saint-gibrien", "saint-martin-sur-le-pré", "saint-memmie",
...
def send_article(title, link, source, category):
    ...
    embed = {
        "title": title,
        "url": link,
        "description": f"{category} Source : {source}",
        "color": 3447003,
        "footer": {
